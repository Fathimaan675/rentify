...
function Authent() {
    ...
    const [sellerInputs,setSellerInputs] = useState({
        place: "", lastname: "", email: "", phonenumber: "", password: ""
      })
      ...
      const handleRegister = async (e) => {
        ...
        if (sellerInputs.firstname && sellerInputs.lastname && sellerInputs.email && sellerInputs.phonenumber && sellerInputs.password) {
            try {
                ...
                console.log(result);
                if (result.status === 201) { // Check if the status is 201 (success)
                    alert(`Welcome ${result.data.seller.firstname}...Please Login to explore our website!!!`);
        ...
        <div className="card shadow p-5">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <img className='w-100' src="https://www.chawtechsolutions.com/wp-content/uploads/2019/03/developer-dribbble.gif" alt="Authentication" />
            </div>
            <div className="col-lg-6">
